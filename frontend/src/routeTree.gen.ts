...
import { Route as ProductCompareRouteImport } from './routes/product/compare'
...
const ProductCompareRoute = ProductCompareRouteImport.update({
  id: '/product/compare',
...
export interface FileRoutesByFullPath {
  ...
  '/product/compare': typeof ProductCompareRoute
...
export interface RootRouteChildren {
  ...
  ProductCompareRoute: typeof ProductCompareRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/product/compare': {
      ...
      preLoaderRoute: typeof ProductCompareRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/order/history': {
      id: '/order/history'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  ProductCompareRoute: ProductCompareRoute,
